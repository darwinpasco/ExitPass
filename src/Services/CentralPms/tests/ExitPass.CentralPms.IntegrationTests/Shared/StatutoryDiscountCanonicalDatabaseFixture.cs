        ...
        public static StatutoryDiscountCanonicalDatabaseFixtureOptions Load(bool validateFiles = true)
        {
            ...
            var applicationSchemaSources = new[]
            {
                ...
                new ApplicationSchemaSource(
                    ...
                    ValidatorPath: null),
                new ApplicationSchemaSource(
                    "canonical human authentication",
                    Path.Combine(patchRoot, "infra", "db", "patches", "ExitPass_HumanAuthentication_v1.3.sql"),
                    Path.Combine(patchRoot, "infra", "db", "patches", "validation", "Validate_HumanAuthentication_v1.3.sql")),
                new ApplicationSchemaSource(
