    ...
    string mainDatabaseConnectionString)
{
    ...
    builder.Services.AddScoped<IStatutoryDiscountServiceChannelAuthorizationService, StatutoryDiscountServiceChannelAuthorizationService>();
    ...
    builder.Services.AddScoped<IStatutoryDiscountZeroPayableFinalityReader>(_ =>
        new PostgresStatutoryDiscountZeroPayableFinalityReader(mainDatabaseConnectionString));
    ...
    builder.Services.AddScoped<IStatutoryDiscountPayableBasisRevalidationService, StatutoryDiscountPayableBasisRevalidationService>();
