...
public sealed class ManagementDashboardReportingService : IManagementDashboardReportingService
{
    ...
    [
        new(
            ...
            ["PAYMENT_RECONCILIATION_DEFERRED", "FISCAL_SUMMARY_DEFERRED", "MANAGEMENT_ACTIVITY_DEFERRED"],
            ["Phase 1 exposes no exports, mutations, payment finality, fiscal authority, settlement closure, or exit authority."]),
        DeferredCatalogEntry(ManagementDashboardReportingValues.PaymentReconciliationReportId, "Payment and reconciliation summary", "Payments and reconciliation"),
